...
def read_real_with_genes(filename, batch=True):
    ...
    # X = np.genfromtxt('D:/coupleCoC_plus/new_data/result/ex2/mS.csv', delimiter=',', skip_header=1, dtype= float)[:,1:]
    # cell_name = np.genfromtxt('D:/coupleCoC_plus/new_data/result/ex2/mS.csv', delimiter=',', skip_header=1, usecols= 0, dtype= str)
    # gene_name = np.genfromtxt('D:/coupleCoC_plus/new_data/result/ex2/mS.csv', delimiter=',', max_rows =1, dtype= str)
    # return X, cell_name, gene_name
